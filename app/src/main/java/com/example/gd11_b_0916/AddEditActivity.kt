package com.example.gd11_b_0916
...
import com.example.gd11_b_0916.api.MahasiswaApi
import com.example.gd11_b_0916.models.Mahasiswa
...
class AddEditActivity : AppCompatActivity() {
    ...
    private fun createMahasiswa(){
        ...
        val stringRequest = object : StringRequest(Method.POST, MahasiswaApi.ADD_URL, Response.Listener { response ->
            val gson = Gson()
            var mahasiswa = gson.fromJson(response, Mahasiswa::class.java)

            if(mahasiswa != null)
                Toast.makeText(this@AddEditActivity, "Data Berhasil Ditambah", Toast.LENGTH_SHORT)
                    .show()
